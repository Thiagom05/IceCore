...
public class Pedido {
    ...
    // "mappedBy" le dice a JPA que la otra clase (ItemPedido) es la dueña de la relación.
    // "cascade = CascadeType.ALL" significa que si borro el pedido, se borran sus items.
