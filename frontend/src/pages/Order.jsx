                                ...
                                <div className="mb-12 flex items-center justify-between bg-gray-50 p-4 rounded-2xl">
                                    ...
                                    <div className="flex items-center gap-6">
                                        <button
                                            ...
                                            className="w-10 h-10 rounded-full bg-white shadow-sm border border-gray-200 flex items-center justify-center text-[#2C1B18] hover:bg-[#2C1B18] hover:text-white transition-colors"
                                        >
                                            <Minus size={18} />
                                        </button>
                                        ...
                                        <button
                                            ...
                                            className="w-10 h-10 rounded-full bg-[#2C1B18] text-white shadow-lg shadow-[#2C1B18]/20 flex items-center justify-center hover:scale-105 active:scale-95 transition-all"
                                        >
                                            <Plus size={18} />
                                        </button>
                                    </div>
